...
namespace My3DGame.GameData
{
    ...
    /// Data 부모 클래스
    /// 공통적인 데이터 : 데이터 이름 리스트
    /// 공통적인 기능 : 데이터 이름 리스트 얻어오기, 데이터 개수 얻어오기, 데이터 추가, 복사, 제거하기
    /// </summary>
    public class BaseData : ScriptableObject
    {
        ...
        //showID: true이면 이름 앞에 인덱스 붙이기, filterWord가 포함된 이름만 출력
        ...
        //데이터 추가하기 - 매개변수로 새로운 데이터 이름을 받아 추가한 후 데이터 리스트 최종 개수 리턴한다
